...
def compute_cost(A2, Y, parameters):
    ...
    # See: https://www.coursera.org/learn/neural-networks-deep-learning/discussions/weeks/3/threads/-t_03YZWEeeDVwqJ_1sy2g
...
def backward_propagation(parameters, cache, X, Y):
    ...
    dZ1 = np.multiply(np.multiply(np.transpose(W2), dZ2), 1 - np.power(A1, 2))
